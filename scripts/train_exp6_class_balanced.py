...
def main():
    ...
    # 3. Build BiGRUAttentionPoolingClassifier (identical to Exp5)
    ...
    print(f"Model Architecture:  BiGRUAttentionPoolingClassifier (Exp5 Base)")
